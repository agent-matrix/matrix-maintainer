...
class Settings(BaseSettings):
    ...
    site_title: str = Field(default="Agent-Matrix Health", alias="SITE_TITLE")
    site_description: str = Field(default="Daily health dashboard for Agent-Matrix repositories and infra.", alias="SITE_DESCRIPTION")
